...
## using with to make a plot using the three different submetering making the plot with the first set and
## adding 2 and 3 with lines as that command adds lines to a plot. It is type l cause it is a lineplot.   
with(data1, {
...
## legend is used to make the box in the corner that shows which set of data is which color. 
